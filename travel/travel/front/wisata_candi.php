                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active" class="dropdown"><a><h5>Wisata Edukasi <i class="fa fa-angle-down"></i></h5></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li class="active"><a href="wisata_candi.php">Candi</a></li>
...
?>
<?php
$sql = "SELECT * from tbwisata INNER JOIN tbkategori ON(tbwisata.kdkategori = tbkategori.kdkategori) INNER JOIN tbdetailwisata ON(tbwisata.kdwisata = tbdetailwisata.kdwisata) WHERE tbwisata.kdkategori=6";

                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active" class="dropdown"><a href="#"><h5>Wisata Alam<i class="fa fa-angle-down"></i></h5></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li class="active"><a href="wisata_airterjun.php">Air Terjun</a></li>
...
?>
<?php
$sql = "SELECT * from tbwisata INNER JOIN tbkategori ON(tbwisata.kdkategori = tbkategori.kdkategori) INNER JOIN tbdetailwisata ON(tbwisata.kdwisata = tbdetailwisata.kdwisata) WHERE tbwisata.kdkategori=2";
                ...
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            ...
                            <p><?php echo "$wisata";  ?>, Merek, Karo.</p>
                        </div>
                     </div>
                </div>
            </div>

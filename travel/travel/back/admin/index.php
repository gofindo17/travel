...
<div class="container-fluid">
  ...
  <div class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_ly span3"> <a href="admin.php"> <i class="icon-reorder"></i> Admin</a> </li>
      <li class="bg_lo span2"> <a href="cafe.php"> <i class="icon-sitemap"></i> Data Cafe</a> </li>
      <li class="bg_ls span7"> <a href="wisata.php"> <i class="icon-plane"></i> Data Wisata BPODT</a> </li>
      <li class="bg_lb span2"> <a href="logout.php"> <i class="icon-globe"></i>Logout</a> </li>
    </ul>
  </div>
  <!--BARIS 2-->
  <div class="container-fluid">
      ...
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-ok"></i></span>
            <h5>Data Tongkrongan Kawasan Danau Toba</h5>
          </div>
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <?php

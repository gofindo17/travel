...
<?php
$sql = "SELECT * FROM tbtongkrongan ORDER BY kdcafe DESC LIMIT 1";
...
<a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
    <a href="order.php" title="Back to Order" class="tip-bottom"><i class="icon-th-list"></i> cafe</a>
    ...
    <div class="row-fluid">
      ...
      <div class="span7">
        <div class="widget-box">
          <div class="widget-title bg_ly"><span class="icon"><i class="icon-chevron-down"></i></span><h5><b>"<?php echo $cafe;?>"</b></h5>
          </div>
        ...
        <div class="control-group">
          <label class="control-label">Galeri Gambar 1 :</label>
            <div class="controls">
            <input type="hidden" name="kdcafe" value="<?php echo $kdcafe; ?>"/>
      ...
      <div class="span5">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-ok"></i></span>
            <h5>Keterangan cafe</h5>
          </div>
          <div class="widget-content nopadding collapse in">
            <ul class="recent-posts">
              <li>

                <div class="article-post"><strong><?php echo $cafe;?></strong>
                  <p>
                    <?php
                    $sql = "SELECT * FROM tbtongkrongan ORDER BY kdcafe DESC LIMIT 1";
                    ...
                    <br><?php echo "<img src='../../front/images/cafe/$data[image]' />";?>
